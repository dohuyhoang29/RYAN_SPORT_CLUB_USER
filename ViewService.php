...
<body>
    ...
    <!-- Nội dung chi tiết của bộ môn thể thao -->
    <section class="aboutus-section spad">
        <div class="container">
            <div class="aboutus-page-text">
                ...
                <img style="width: 100%; height: 100%;" src="<?php echo  './img/' . $service['URL']; ?>" alt="">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-us">
                            <h4>Famous Players</h4>
                            <p><?php echo $service['Famous_Players']; ?></p>
                        </div>
                        <div class="about-us">
                            <h4>Time</h4>
                            <p><?php echo $service['Time']; ?> min</p>
                        </div>
                        <div class="about-us">
                            <h4>Category</h4>
                            <p><?php echo $service['CategoryName']; ?></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-quality">
                            <h4>RULES</h4>
                            <p class="rules"><?php echo $service['Rules']; ?>
                            </p>
                            <!-- Button modal -->
