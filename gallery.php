...
<body>
    ...
    <!-- code tạo thanh navbar -->
    <?php
        include_once('./header.php');
    ?>

    <!-- kết thúc code tạo thanh navbar -->

    <!-- code tạo thanh menu con  -->
    ...
    <!-- kết thúc code tạo thanh menu con -->

    <!-- code tạo phần hiển thị ảnh -->
    <section class="gallery-section spad">
        <div class="container">
            ...
            <div class="row gallery-filter">
                ...
                ?>
                    <?php if ($picture['Category'] == "Indoor Sport") : ?>
                        <div class="col-lg-3 col-sm-4 mix * indoor">
                        <?php endif; ?>
                    <?php if ($picture['Category'] == "Outdoor Sport") : ?>
                        <div class="col-lg-3 col-sm-4 mix * outdoor">
                    <?php endif; ?>
                    <?php if ($picture['Category'] == "Recreation") : ?>
                        ...
                        <div class=" gi-hover-warp">
                            <div class="gi-hover">
                                ...
                                <h6><?php echo $picture['Name']; ?>
                                    <?php if ($picture['Category'] == "Indoor Sport") : ?>
                                        <span><?php echo $picture['Category']; ?></span>
                                    <?php endif; ?>
                                    <?php if ($picture['Category'] == "Outdoor Sport") : ?>
                                        <span><?php echo $picture['Category']; ?></span>
                                    <?php endif; ?>
                ...
                <div class="col-lg-3">
                    <div class="footer-logo-item">
                        ...
                        <div class="social-links">
                            ...
                            <a href="https://www.youtube.com/user/aprotrainaptechvn"><i class="fa fa-youtube-play"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <script src="js/bootstrap.min.js"></script>
    <script>
        //js để khi không nhập j vào ô search thì k bị chuyển sang trang search.php
