...
<body>
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            ...
            <div class="single-hero-item set-bg" data-setbg="img/hero-slider/banner4.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-text">
                        <h2>WELCOME TO RYAN SPORT CLUB</h2>
                        <p class="short-details">RYAN Sports Club, an effort has been made to provide a world class
                            facilities and infrastructure for the promotion of sports and health. </p>
                        <p class="long-details">During the past time,
                            RYAN sports club has emerged as one of the best facilities in the country in the area of
    ...
    <section class="classes-section">
                ...
                <div class="row">
                    <div class="col-lg-7 m-auto text-center">
                        <div class="section-title pl-lg-4 pr-lg-4 pl-0 pr-0">
                            <h2>Choose Event</h2>
                            <p>Our club has events that entertain you or compete with each other for amazing prizes. We
                                have tournaments where you can play against foreign opponents.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="img/classes/class2.jpg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Our club offers world-class entertainment and support facilities.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>Support 24/24</h5>
                        <p>Our customer support system is available 24 hours a day. We support you anytime and anywhere.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>Our trainer</h5>
                        <p>Our club has world class coaches. They will support your training throughout your membership
                            in our club.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>Our equipment</h5>
                        <p>Our facilities are state-of-the-art equipment available today. Imported from the most famous
                            manufacturers.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>Classes daily</h5>
                        <p>Our classes are open daily. You can sign up for any class during your free time.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
    ...
    <div class="map">
        <iframe
            ...
            height="590" style="border: 0" allowfullscreen="">
        </iframe>
